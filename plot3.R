...
# loading data
neiData <- readRDS("Expo-data/summarySCC_PM25.rds")
sccData <- readRDS("Expo-data/Source_Classification_Code.rds")
...
# final results :)
png(filename = "Expo-data/plot3.png", width = 480, height = 480, units = "px")
